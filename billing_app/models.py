...
class Brand_details(models.Model):
    id = models.AutoField(primary_key=True)
    product_type_id_fk  = models.ForeignKey(Product_type, on_delete=models.CASCADE)
...
class Stock_details(models.Model):
    ...
    shop_id_fk  = models.ForeignKey(Shop_details, on_delete=models.CASCADE)
...
class Stock_recived_details(models.Model):
    ...
    shop_id_fk  = models.ForeignKey(Shop_details, on_delete=models.CASCADE)
    product_type_id_fk  = models.ForeignKey(Product_type, on_delete=models.CASCADE)
    brand_id_fk  = models.ForeignKey(Brand_details, on_delete=models.CASCADE)
